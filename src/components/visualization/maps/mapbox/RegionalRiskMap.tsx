    ...
    <MapboxProvider>
      ...
      >
        ...
        <div className="mt-4 text-sm text-gray-400 flex items-start gap-2">
          ...
          <p>
            Regional risks are calculated based on proximity to predicted impact zones and population density. 
            Click on regions to view detailed risk assessments and population exposure data.
          </p>
        </div>
      </motion.div>
    </MapboxProvider>
